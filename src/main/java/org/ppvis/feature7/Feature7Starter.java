...
import org.ppvis.feature7.view.GetRecipesWithoutAllergyCommand;
...
public class Feature7Starter {
    public static void main(String[] args) throws URISyntaxException {
        ...
        System.out.println(loadedRecipesRepository);

        MainLoop mainLoop = new MainLoopImpl(new StartQuestionCommand(new StartWindowController(lastRecipe)));
        mainLoop.addCommand(new GetRecipesWithoutAllergyCommand(new GetRecipesByMealTimeAndRequiredComponentWithoutAllergyController(loadedRecipesRepository, loadedProductsRepository)));
